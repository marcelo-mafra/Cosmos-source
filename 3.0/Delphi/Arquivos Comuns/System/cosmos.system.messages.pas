  ...
  TEmailConst = class
   ...
   TCosmosLogs =  class
    const
      ...
      LogSystemStarted          = 'O serviço de registro de logs foi inicializado com sucesso!';
      //Tipos de logs
      ...
      ConnectedUser             = 'Usuário %s conectado ao Cosmos com sucesso!';
      DisconnectedUser          = 'Usuário %s desconectado do Cosmos com sucesso!';
      ...
      NetOnConnectEvent         = 'Recebendo solicitação de conexão de rede.';
      NetOnDisconnectEvent      = 'Conexão do usuário encerrada.';
      NetTransportClientIp      = 'Client IP: %s';
      NetTransportClientPort    = 'Porta de comunicação: %s';
      NetTransportProtocol      = 'Protocolo de comunicação: %s';
  ...
  ///   relacionada a datanavigators.
   ...
   TCosmosErrorMsg =  class
    const
     ...
     ConnectionLost = 'A conexão com o servidor remoto foi perdida. Será necessário reiniciar a autenticação para continuar. Mensagem de erro recebida:';
     //Cidades e estados------------------------------------------------------------
