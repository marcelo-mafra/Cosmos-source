...
uses
  Winapi.Windows, System.SysUtils, System.Classes, Vcl.Dialogs, System.Variants,
  cosmos.system.types, cosmos.system.messages, cosmos.system.exceptions, Data.DB,
  ...
  Xml.xmldom, Xml.Win.msxmldom, Data.DBXCommon, Data.SqlExpr,
...
type
  ...
  private
    ...
    procedure UpdateBufferedTablesControlFile(const Table: TCosmosTables;
      NewVersion: integer);
    function GetICosmosApplication: ICosmosApplication;
  ...
  public
    ...
    property ICosmosApp: ICosmosApplication read GetICosmosApplication;
...
function TDMBase.GetICosmosApplication: ICosmosApplication;
begin
