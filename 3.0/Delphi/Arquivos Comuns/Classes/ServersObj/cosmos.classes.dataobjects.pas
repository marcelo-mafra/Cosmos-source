...
uses
 ...
 cosmos.classes.application, System.Variants, Datasnap.Provider, cosmos.system.messages,
  cosmos.classes.serversutils, cosmos.classes.cripter,
...
begin
 ...
 //   dbConn.LoadParamsFromIniFile(self.FConnectionParamsFile);
   ...
   //Inicia a inserção da conexão configurada ao pool de conexões.
    ...
    //dbconn.Params.SaveToFile('C:\Sistema Cosmos\3.5\Parammmmmmmmmmmmm.txt');
    dbconn.Open;
