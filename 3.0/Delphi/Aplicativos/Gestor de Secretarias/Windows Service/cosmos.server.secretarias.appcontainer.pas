...
uses Winapi.Windows, System.SysUtils, System.Classes, Vcl.SvcMgr, Datasnap.DSTCPServerTransport,
  ...
  cosmos.classes.persistence.ini, cosmos.classes.persistence.registry, Data.DBCommonTypes;
...
type
  ...
  TCosmosSecretariasService = class(TService)
...
var
  CosmosSecretariasService: TCosmosSecretariasService;
...
begin
  CosmosSecretariasService.Controller(CtrlCode);
end;
...
//Métodos para controle do serviço pelo Windows.
function TCosmosSecretariasService.DoContinue: Boolean;
begin
  Result := inherited;
  DSServerSecretarias.Start;
end;

function TCosmosSecretariasService.GetServiceController: TServiceController;
begin
  Result := ServiceController;
end;

procedure TCosmosSecretariasService.DoInterrogate;
begin
  inherited;
end;

function TCosmosSecretariasService.DoPause: Boolean;
begin
  DSServerSecretarias.Stop;
  Result := inherited;
end;

function TCosmosSecretariasService.DoStop: Boolean;
begin
  DSServerSecretarias.Stop;
  Result := inherited;
end;

procedure TCosmosSecretariasService.DSServerApplicationClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TDMCosmosApplicationServer;
end;

procedure TCosmosSecretariasService.DSServerAtividadesClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TDMSecAtividadesServerMethods;
end;

procedure TCosmosSecretariasService.DSServerHistoricoClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TCosmosSecHistoricoServerMethods;
end;

procedure TCosmosSecretariasService.DSServerLectoriumClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TDMSecLectoriumServerMethods;
end;

procedure TCosmosSecretariasService.DSServerLogradourosClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TDMCosmosServerLogradouros;
end;

procedure TCosmosSecretariasService.DSServerSecretariasConnect(
  DSConnectEventObject: TDSConnectEventObject);
var
 AInfo: string;
...
begin
 ...
 //Registra qual o servidor Cosmos que está usando a classe TCosmosSecretariasService.
...
procedure TCosmosSecretariasService.DSServerSecretariasDisconnect(
  DSConnectEventObject: TDSConnectEventObject);
var
 AInfo: string;
 AContextInfo: TStringList;
...
procedure TCosmosSecretariasService.DSServerSecretariasError(
...
procedure TCosmosSecretariasService.DSServerSecretariasPrepare(
  DSPrepareEventObject: TDSPrepareEventObject);
var
 Info: string;
 AContextInfo: TStringList;
...
function TCosmosSecretariasService.DSServerSecretariasTrace(
...
procedure TCosmosSecretariasService.DSServerTPClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TCosmosSecTPServerMethods;
end;

procedure TCosmosSecretariasService.DSTCPServerTransportConnect(
...
procedure TCosmosSecretariasService.DSTCPServerTransportDisconnect(
  Event: TDSTCPDisconnectEventObject);
var
 AInfo: string;
 AContextInfo: TStringList;
...
procedure TCosmosSecretariasService.LoadMethodsAuthorizations;
var
...
procedure TCosmosSecretariasService.LoadServerConfigurations;
 var
...
{Carregas as configurações do servidor em execução. Estas configurações envolvem
 ...
 try
  ...
  DSTCPServerTransport.Port := AFile.ReadInteger('GSEC', 'TCPConnection.Port', 2100);
  ...
  //Opções de KeepAlive.
  if AFile.ReadBoolean('GSEC', 'TCPConnection.KeepAliveEnablement', False) then
   begin
     DSTCPServerTransport.KeepAliveEnablement := kaEnabled;
     DSTCPServerTransport.KeepAliveTime := AFile.ReadInteger('GSEC', 'TCPConnection.KeepAliveTime', 300000);
     DSTCPServerTransport.KeepAliveInterval := AFile.ReadInteger('GSEC', 'TCPConnection.KeepAliveInterval', 100);
   end;  
...
procedure TCosmosSecretariasService.ServiceShutdown(Sender: TService);
begin
 if Assigned(DMServerDataAcess) then
  DMServerDataAcess.ConnectionPool.ClearAll;
end;

procedure TCosmosSecretariasService.ServiceStart(Sender: TService;
  var Started: Boolean);
begin
  DSServerSecretarias.Start;
end;

{constructor TCosmosSecretariasService.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TCosmosSecretariasService.Destroy;
begin
  inherited;
  FDSServer := nil;
...
procedure TCosmosSecretariasService.ServiceAfterInstall(Sender: TService);
const
 sServiceDescription = 'Implementa o servidor Cosmos Gestor Financeiro, da ' +
 'suíte Cosmos. Esse serviço disponibiliza acesso às funcionalidades relacionadas ' +
 'aos processos de gestão das secretarias da Escola Internacional da Rosacruz Áurea.';//do not localize!
var
...
procedure TCosmosSecretariasService.ServiceCreate(Sender: TObject);
begin
 FDSServer := DSServerSecretarias;
 FDSAuthenticationManager := DSAuthenticationManager;
...
procedure TCosmosSecretariasService.ServiceDestroy(Sender: TObject);
begin
  FDSServer := nil;
  FDSAuthenticationManager := nil;
...
procedure TCosmosSecretariasService.DSAuthenticationManagerUserAuthenticate(
...
procedure TCosmosSecretariasService.DSAuthenticationManagerUserAuthorize(
...
procedure TCosmosSecretariasService.DSEscolaInternaClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := TCosmosSecEIServerMethods;
end;

procedure TCosmosSecretariasService.DSFocosClassGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
