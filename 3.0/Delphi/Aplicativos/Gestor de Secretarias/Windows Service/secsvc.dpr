...
uses
  ...
  cosmos.server.secretarias.appcontainer in 'cosmos.server.secretarias.appcontainer.pas' {CosmosSecretariasService: TDataModule};
...
begin
  ...
  Application.CreateForm(TCosmosSecretariasService, CosmosSecretariasService);
  Application.Run;
end.
