unit cosmos.server.webmodule;

interface

uses
  System.SysUtils, System.Classes, Web.HTTPApp, Datasnap.DSHTTPCommon,
  Datasnap.DSHTTPWebBroker, Web.WebFileDispatcher, Web.HTTPProd,
  Datasnap.DSProxyJavaScript, IPPeerServer, Datasnap.DSMetadata,
  Datasnap.DSServerMetadata, Datasnap.DSClientMetadata, Datasnap.DSHTTP,
  Datasnap.DSCommonServer, Datasnap.DSProxyDispatcher;
...
uses Web.WebReq, cosmos.server.srvcontainer, cosmos.server.resources.focus;
