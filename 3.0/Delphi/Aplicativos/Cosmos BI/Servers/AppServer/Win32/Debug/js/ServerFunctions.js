...
function Focus(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("Focus",connectionInfo);

  /*
   * @return result - Type on server: TJSONArray
   */
  this.GetActiveFocus = function() {
    var returnObject = this.executor.executeMethod('GetActiveFocus', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetActiveFocus_URL = function() {
    return this.executor.getMethodURL("GetActiveFocus", "GET", [], arguments[0])[0];
  };

  /*
   * @param FocusId [in] - Type on server: Integer
   * @return result - Type on server: TJSONObject
   */
  this.GetFocusDetails = function(FocusId) {
    var returnObject = this.executor.executeMethod('GetFocusDetails', "GET", [FocusId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.FocusId = FocusId;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetFocusDetails_URL = function(FocusId) {
    return this.executor.getMethodURL("GetFocusDetails", "GET", [FocusId], arguments[1])[0];
  };

  /*
   * @param RegionId [in] - Type on server: Integer
   * @return result - Type on server: TJSONArray
   */
  this.GetFocusRegion = function(RegionId) {
    var returnObject = this.executor.executeMethod('GetFocusRegion', "GET", [RegionId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.RegionId = RegionId;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetFocusRegion_URL = function(RegionId) {
    return this.executor.getMethodURL("GetFocusRegion", "GET", [RegionId], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TJSONArray
   */
  this.GetRootRegions = function() {
    var returnObject = this.executor.executeMethod('GetRootRegions', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetRootRegions_URL = function() {
    return this.executor.getMethodURL("GetRootRegions", "GET", [], arguments[0])[0];
  };

  /*
   * @param RootRegionId [in] - Type on server: Integer
   * @return result - Type on server: TJSONArray
   */
  this.GetChildRegions = function(RootRegionId) {
    var returnObject = this.executor.executeMethod('GetChildRegions', "GET", [RootRegionId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.RootRegionId = RootRegionId;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetChildRegions_URL = function(RootRegionId) {
    return this.executor.getMethodURL("GetChildRegions", "GET", [RootRegionId], arguments[1])[0];
  };
}

function Pupils(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("Pupils",connectionInfo);

  /*
   * @param FocusId [in] - Type on server: Integer
   * @return result - Type on server: TJSONObject
   */
  this.CountActivePupils = function(FocusId) {
    var returnObject = this.executor.executeMethod('CountActivePupils', "GET", [FocusId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.CountActivePupils_URL = function(FocusId) {
    return this.executor.getMethodURL("CountActivePupils", "GET", [FocusId], arguments[1])[0];
  };
  ...
  this.GetGrades = function() {
    var returnObject = this.executor.executeMethod('GetGrades', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetGrades_URL = function() {
    return this.executor.getMethodURL("GetGrades", "GET", [], arguments[0])[0];
  };

  /*
   * @param FocusId [in] - Type on server: string
   * @return result - Type on server: TJSONArray
   */
  this.GetPupils = function(FocusId) {
    var returnObject = this.executor.executeMethod('GetPupils', "GET", [FocusId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetPupils_URL = function(FocusId) {
    return this.executor.getMethodURL("GetPupils", "GET", [FocusId], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TJSONArray
   */
  this.GetTotalPupilsFocus = function() {
    var returnObject = this.executor.executeMethod('GetTotalPupilsFocus', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetTotalPupilsFocus_URL = function() {
    return this.executor.getMethodURL("GetTotalPupilsFocus", "GET", [], arguments[0])[0];
  };

  /*
   * @param PupilId [in] - Type on server: Integer
   * @return result - Type on server: TJSONObject
   */
  this.GetPupilName = function(PupilId) {
    var returnObject = this.executor.executeMethod('GetPupilName', "GET", [PupilId], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.PupilId = PupilId;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetPupilName_URL = function(PupilId) {
    return this.executor.getMethodURL("GetPupilName", "GET", [PupilId], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "Focus": ["GetActiveFocus","GetFocusDetails","GetFocusRegion","GetRootRegions","GetChildRegions"],
  "Pupils": ["CountActivePupils","GetGrades","GetPupils","GetTotalPupilsFocus","GetPupilName"]
};
