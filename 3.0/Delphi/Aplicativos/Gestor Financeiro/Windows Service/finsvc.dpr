...
uses
  ...
  cosmos.server.financeiro.appcontainer in 'cosmos.server.financeiro.appcontainer.pas' {CosmosFinanceiroService: TDataModule};
...
begin
  ...
  Application.CreateForm(TCosmosFinanceiroService, CosmosFinanceiroService);
  Application.Run;
end.
