...
uses
  Vcl.SvcMgr,
  cosmos.server.users.appcontainer in 'cosmos.server.users.appcontainer.pas' {CosmosUsuariosService: TDataModule},
...
begin
  ...
  Application.CreateForm(TCosmosUsuariosService, CosmosUsuariosService);
  Application.Run;
end.
