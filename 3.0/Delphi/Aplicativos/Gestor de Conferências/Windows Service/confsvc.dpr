...
uses
  ...
  cosmos.server.conferencias.appcontainer in 'cosmos.server.conferencias.appcontainer.pas' {CosmosConferenciasService: TDataModule},
...
begin
  ...
  Application.CreateForm(TCosmosConferenciasService, CosmosConferenciasService);
  Application.Run;
end.
